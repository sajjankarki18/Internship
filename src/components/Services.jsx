        ...
        <div>
            <div className='container d-flex justify-content-around' style={{ marginBottom: '150px' }}>
                <div className="left-section">
                    <h3 className="display-5 fw-bold mb-3" style={{ fontSize: '2rem', letterSpacing: '2px', lineHeight: '45px', fontWeight: '600' }}>COMPLETE PEST <br />PROTECTION, FROM PEOPLE <br />WHO CARE</h3>
                    <p style={{fontFamily: 'outfit'}} className='content text-muted mb-3'>We’re known as pest exterminators, termite control specialists and a major authority when it comes to on pest control in Australia, but we’re actually much more than that. Competitive Pest Control is also an award-winning business that’s supported by a down to earth approach. Our friendly, professionally trained technicians will meet you on time, in time, every time to solve your pest problems..</p>
                ...
                <div className='right-section'>
                    <div className='service-div border-bottom border-3'>
                        ...
                        <p className='service-para'>Same-day Appointments</p>
                        <hr />
                    </div>

                    <div className='service-div border-bottom border-3'>
                        <img className='service-image' src={meetingImage} alt={meetingImage} />
                        <p className='service-para'>Professional customer support</p>
                        <hr />
                    </div>

                    <div className='service-div border-bottom border-3'>
                        <img className='service-image' src={gauranteeImage} alt={gauranteeImage} />
                        <p className='service-para'>Approved and safe Pest control products</p>
                        <hr />
                    </div>

                    <div className='service-div border-bottom border-3'>
                        <img className='service-image' src={bugImage} alt={bugImage} />
                        <p className='service-para'>Complete inspection and treatment</p>
                        <hr />
                    </div>
                </div>
            </div>
